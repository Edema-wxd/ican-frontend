...
function FaqEdit() {
  ...
  return (  <div>
    <div>
      <InputEle label="Question" type="text" id="title" placeholder="Enter Question" onChange={() => {}} />
      <InputEle label="Answer" type="text" id="answer" placeholder="Enter Answer" onChange={() => {}} />
