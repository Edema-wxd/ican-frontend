  ...
  return (
    <div className="pt-4 flex flex-col justify-between gap-4 ">
      ...
      <div className="flex flex-col w-full gap-10 ">
        <div className=" w-full h-fit col-span-2 flex flex-col gap-3">
          <label
            className=" text-base font-sans font-semibold  "
            htmlFor="contactAddress"
          >
            Contact Address <span className="text-red-600">*</span>
          </label>
          <input
        ...
        <div className="grid grid-cols-2 gap-4 ">
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Contact Country <span className="text-red-600">*</span>
            </label>
            <select
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Conatct State <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            <label
              ...
              htmlFor="contactCity"
            >
              Contact City <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Residential Country <span className="text-red-600">*</span>
            </label>
            <select
              className=" bg-white p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Residential State <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Residential LGA of origin <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            <label
              className=" text-base font-sans font-semibold  "
              htmlFor="residentialTelephone"
            >
              Residential Telephone <span className="text-red-600">*</span>
            </label>
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            ...
            >
              Office Country <span className="text-red-600">*</span>
            </label>
            <select
              className=" bg-white p-3 rounded border border-gray-400  "
              name="officeCountry"
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            <label
              ...
              htmlFor="officeState"
            >
              Office State <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            <label
              ...
              htmlFor="officeCity"
            >
              Office City <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
          ...
          <div className=" w-full h-fit flex flex-col gap-3">
            <label
              ...
              htmlFor="officeLga"
            >
              Office LGA <span className="text-red-600">*</span>
            </label>
            <input
              className=" p-3 rounded border border-gray-400  "
              placeholder="Enter your the LGA of your office"
              name="officeLga"
              id="officeLga"
              required
              type="text"
