  ...
  return (
    <div className="pt-4 flex flex-col justify-between gap-4 ">
      ...
      <div className="grid grid-cols-2  gap-10 ">
        ...
        <div className=" w-full h-fit flex flex-col gap-3">
          <label className=" text-base font-sans font-semibold  " htmlFor="dob">
        ...
        <div className=" w-full h-fit flex flex-col gap-3">
          <label className=" text-base font-sans font-semibold  " htmlFor="lga">
            LGA of origin <span className="text-red-600">*</span>
          </label>
          <input
            className=" p-3 rounded border border-gray-400  "
